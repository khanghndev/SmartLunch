        ...
        CancellationToken cancellationToken)
    {
        ...
        var weeks = selections.Select(sel =>
        {
            ...
            return new ContractWeeklySelectionDto
            {
                ...
                FulfillmentOrderStatus = sel.FulfillmentOrder?.Status,
                FulfillmentPaymentStatus = sel.FulfillmentOrder?.PaymentStatus,
                FulfillmentInvoiceCode = sel.FulfillmentOrder?.InvoiceCode,
