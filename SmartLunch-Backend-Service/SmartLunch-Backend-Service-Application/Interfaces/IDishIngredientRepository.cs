...
public interface IDishIngredientRepository
{
    ...
    Task<DishIngredient?> GetByDishAndIngredientAsync(int dishId, int ingredientId);
    ...
    Task<bool> DeleteByDishAndIngredientAsync(int dishId, int ingredientId);
    Task<bool> ExistsByDishAndIngredientAsync(int dishId, int ingredientId);
}
