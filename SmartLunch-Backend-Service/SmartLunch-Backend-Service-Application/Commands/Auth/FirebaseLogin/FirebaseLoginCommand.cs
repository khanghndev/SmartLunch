...
public class FirebaseLoginCommand : IRequest<LoginResponse>
{
    public FirebaseLoginRequest Request { get; set; }

    public FirebaseLoginCommand(FirebaseLoginRequest request)
    {
        Request = request;
    }
}
