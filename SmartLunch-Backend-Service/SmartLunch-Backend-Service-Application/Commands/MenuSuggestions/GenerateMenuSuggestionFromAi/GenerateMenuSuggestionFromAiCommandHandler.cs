    ...
    : IRequestHandler<GenerateMenuSuggestionFromAiCommand, CreateMenuSuggestionResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var aiReq = new AiIndustrialMenuPlansRequest
        {
            ...
            Days = req.Days,
            MealStructure = req.MealStructure,   // FE sends English enum values (main|side|soup|...)
            TopK = req.TopK,
        ...
        _logger.LogInformation(
            "Calling AI with {DishCount} dishes, {IngCount} available ingredients",
            aiDishes.Count, availableIngredients.Count);
