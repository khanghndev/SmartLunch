...
namespace SmartLunch.Backend.Service.Infrastructure.Data
{
    ...
    public class SmartLunchDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CompanyPublicDocument>(entity =>
            {
                entity.ToTable("company_public_documents");
                entity.HasKey(e => e.Id);
                entity.HasIndex(e => new { e.IsPublished, e.SortOrder });
            ...
            modelBuilder.Entity<Contract>(entity =>
            {
                ...
                entity.Property(e => e.MealUnitPrice).HasPrecision(12, 2);
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.RecipientName).HasMaxLength(120);
                entity.Property(e => e.RecipientPhone).HasMaxLength(20);
                entity.Property(e => e.RecipientEmail).HasMaxLength(254);
                entity.Property(e => e.DeliveryAddress).HasMaxLength(500);
                entity.Property(e => e.DeliveryWardDistrict).HasMaxLength(255);
                entity.Property(e => e.DeliveryNotes).HasMaxLength(500);
                entity.Property(e => e.PreferredDeliveryTime).HasMaxLength(32);
            ...
            modelBuilder.Entity<Delivery>(entity =>
            {
                ...
                entity.Property(e => e.HandoverDocumentUrl).HasMaxLength(500);
                entity.Property(e => e.ShipperSignatureUrl).HasMaxLength(500);
