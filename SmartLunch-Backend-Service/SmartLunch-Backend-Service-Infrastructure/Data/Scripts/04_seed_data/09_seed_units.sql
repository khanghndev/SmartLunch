-- Seed: Units & User-Unit memberships
INSERT INTO units (Name, Address, Phone, ContactPerson, ContactEmail, IsActive, CreatedBy) VALUES
...
SELECT u.Id, un.Id, NOW(), 1 FROM users u, units un WHERE u.Username = 'cty_abc' AND un.Name = 'Công ty TNHH ABC Tech';
INSERT INTO user_units (UserId, UnitId, JoinedAt, IsActive)
SELECT u.Id, un.Id, NOW(), 1 FROM users u, units un WHERE u.Username = 'truong_xyz' AND un.Name = 'Trường THPT XYZ';
INSERT INTO user_units (UserId, UnitId, JoinedAt, IsActive)
