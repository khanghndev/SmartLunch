...
-- NCC / Hợp đồng: đọc; Thanh toán NCC: đọc + ghi nhận chi công nợ
OR (p.Resource IN ('partners', 'contracts') AND p.Action IN ('read', 'list'))
OR (p.Resource = 'partner_payments' AND p.Action IN ('read', 'list', 'create'));
