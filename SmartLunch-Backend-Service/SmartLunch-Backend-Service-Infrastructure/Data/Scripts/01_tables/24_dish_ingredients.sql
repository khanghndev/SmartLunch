CREATE TABLE dish_ingredients (
    ...
    DishValueId INT NOT NULL COMMENT 'FK dish_values — định mức theo mức giá suất ăn',
    Quantity DECIMAL(10,2) NOT NULL,
    Unit VARCHAR(20) NULL,
    PRIMARY KEY (Id),
    UNIQUE KEY UK_dish_ingredients_code (Code),
    UNIQUE KEY UK_dish_ingredients_dish_ing_value (DishId, IngredientId, DishValueId),
    INDEX IX_dish_ingredients_ingredient (IngredientId),
    INDEX IX_dish_ingredients_dish_value (DishValueId),
    ...
    CONSTRAINT FK_dish_ingredients_dish_value FOREIGN KEY (DishValueId) REFERENCES dish_values (Id) ON DELETE RESTRICT ON UPDATE CASCADE
