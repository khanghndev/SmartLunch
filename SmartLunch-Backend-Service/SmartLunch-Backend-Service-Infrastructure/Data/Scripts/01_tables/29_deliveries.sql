CREATE TABLE deliveries (
    ...
    RecipientConfirmationCode VARCHAR(20) NULL COMMENT 'Legacy OTP (không dùng khi chữ ký)',
    RecipientSignatureUrl VARCHAR(500) NULL COMMENT 'URL ảnh chữ ký người nhận',
