...
| **Đặt suất ăn theo hợp đồng (Period-Based)** | [org_meal_period_contract_index_page.dart](file:///h:/EngineeringThesis/Khoa_Luan_KS_Mobile/lib/src/features/organization/presentation/pages/org_meal_period_contract_index_page.dart) *(Thiết lập kỳ + ngày nghỉ + số suất/ngày + giá/suất + giao hàng)*<br>[org_meal_period_contract_review_page.dart](file:///h:/EngineeringThesis/Khoa_Luan_KS_Mobile/lib/src/features/organization/presentation/pages/org_meal_period_contract_review_page.dart) *(Rà soát → checkout → ký phụ lục → PayOS)*<br>[org_order_annex_sign_page.dart](file:///h:/EngineeringThesis/Khoa_Luan_KS_Mobile/lib/src/features/organization/presentation/pages/org_order_annex_sign_page.dart) *(ký phụ lục; PayOS qua **meal-contract-order**)* | `GET /api/v1/organization/meal-contract-order/dish/main`<br>`POST /api/v1/organization/meal-contract-order/contract`<br>`POST /api/v1/organization/meal-contract-order/checkout`<br>`POST /api/v1/organization/meal-contract-order/pay`<br>`POST /api/v1/organization/meal-contract-order/{contractId}/weekly-meals` | ✅ Hoàn thành (core flow) |
