...
/// Mở PayOS thanh toán cọc cho hợp đồng theo kỳ (Period-Based) — API `/organization/meal-contract-order/pay`.
class OrgMealPeriodPayDeposit {
  static Future<void> launch({
    ...
    try {
      ...
      final pay = await OrgRepository.instance.initiateMealPeriodPayment(
        orderId: orderId,
          ...
          content: Text(
            amount > 0
                ? 'Đã chuyển sang PayOS để thanh toán cọc '
                    ...
                    'Đơn #$orderId chỉ chuyển trạng thái sau khi PayOS xác nhận.'
