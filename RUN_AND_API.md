...
---
 ...
 2. Running the Backend Service (ASP.NET Core)
...
---
 ...
 3. Running the AI Service (FastAPI)
...
---
 ...
 5.1 Backend Service (`http://localhost:5001/api/v1`)
...
---
 ...
 5.2 AI Service (`http://localhost:8001`)
